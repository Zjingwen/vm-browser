!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : t(
        ((e =
          "undefined" != typeof globalThis ? globalThis : e || self).secsdk =
          {})
      );
})(this, function (e) {
  "use strict";
  ...
  var r = n(function (e) {
    ...
    M = i["__core-js_shared__"] || x("__core-js_shared__", {}),
    U = Function.toString;
  ...
  var C,
    ...
    F = M.inspectSource,
    _ = i.WeakMap,
    N = "function" == typeof _ && /native code/.test(F(_)),
    B = n(function (e) {
    ...
    K = i.WeakMap;
  if (N) {
    var $ = M.state || (M.state = new K()),
      Y = $.get,
      J = $.has,
      Z = $.set;
    (C = function (e, t) {
      return (t.facade = e), Z.call($, e, t), t;
    }),
      (H = function (e) {
        return Y.call($, e) || {};
      }),
  ...
  var ee = {
    ...
    te = n(function (e) {
      ...
      (e.exports = function (e, t, o, a) {
        var u,
          ...
          f = !!a && !!a.noTargetGet;
        "function" == typeof o &&
          ("string" != typeof t || S(o, "name") || q(o, "name", t),
          (u = n(o)).source ||
            (u.source = r.join("string" == typeof t ? t : ""))),
          e !== i
            ? (c ? !f && e[t] && (s = !0) : delete e[t],
              s ? (e[t] = o) : q(e, t, o))
            : s
            ? (e[t] = o)
            : x(t, o);
    ...
    Te = function (e, t) {
      var n,
        ...
        f = e.global,
        l = e.stat;
      if ((n = f ? i : l ? i[s] || x(s, {}) : (i[s] || {}).prototype)) {
        for (o in t) {
          if (
            ((u = t[o]),
          ...
          (e.sham || (a && a.sham)) && q(u, "sham", !0), te(n, o, u, e);
        }
      }
    },
    qe = function (e) {
    ...
    He = Ce && !Symbol.sham && "symbol" == r(Symbol.iterator),
    Ie = B("wks"),
    Fe = i.Symbol,
    _e = He ? Fe : (Fe && Fe.withoutSetter) || G,
    Ne = function (e) {
      return (
        S(Ie, e) ||
          (Ce && S(Fe, e) ? (Ie[e] = Fe[e]) : (Ie[e] = _e("Symbol." + e))),
        Ie[e]
      );
    },
    Be = Ne("species"),
    De = function (e, t) {
      ...
      return (
        Ue(e) &&
          ...
          (n !== Array && !Ue(n.prototype))
            ? m(n) && null === (n = n[Be]) && (n = void 0)
            : (n = void 0)),
      ...
      return function (c, s, f, l) {
        for (
          var h,
            ...
            w = 0,
            b = l || De,
            S = t ? b(c, m) : n || a ? b(c, 0) : void 0;
          m > w;
          w++
        ) {
          if ((u || w in y) && ((p = g((h = y[w]), w, v)), e)) {
            if (t) {
              S[w] = p;
            } else if (p) {
              switch (e) {
  ...
  var dt,
    yt,
    gt = oe("navigator", "userAgent") || "",
    mt = i.process,
    wt = mt && mt.versions,
    bt = wt && wt.v8;
  bt
    ? (yt = (dt = bt.split("."))[0] + dt[1])
    : gt &&
      (!(dt = gt.match(/Edge\/(\d+)/)) || dt[1] >= 74) &&
      (dt = gt.match(/Chrome\/(\d+)/)) &&
      (yt = dt[1]);
  var St = yt && +yt,
    kt = Ne("species"),
    Rt = Ve.map,
  ...
  var Pt = Object.assign,
    ...
    qt =
      ...
      a(function () {
        ...
        ? function (e, t) {
            for (
              var n = Me(e), r = arguments.length, o = 1, i = we.f, a = f.f;
              r > o;
              ...
              for (
                var c,
                  s = d(arguments[o++]),
                  l = i ? nt(s).concat(i(s)) : nt(s),
                  h = l.length,
                  p = 0;
                h > p;

              ) {
                (c = l[p++]), (u && !a.call(s, c)) || (n[c] = s[c]);
              }
            }
            return n;
          }
  ...
  Mt ||
    te(Object.prototype, "toString", It, {
      unsafe: !0,
    });
  var Ft = i.Promise,
    _t = function (e, t, n) {
    ...
    Qt = function (e, t, n) {
      var o,
        ...
        d = xe(t, l, 1 + h + v),
        y = function (e) {
          return o && Jt(o), new Zt(!0, e);
        },
        g = function (e) {
          return h
            ? (O(e), v ? d(e[0], e[1], y) : d(e[0], e[1]))
            : v
            ? d(e, y)
            : d(e);
        };
      if (p) {
        ...
        if ("function" != typeof (i = Yt(e))) {
          throw TypeError("Target is not iterable");
        }
        if (Kt(i)) {
          for (a = 0, u = se(e.length); u > a; a++) {
  ...
  var on,
    ...
    fn = /(iphone|ipod|ipad).*applewebkit/i.test(gt),
    ln = "process" == p(i.process),
    hn = i.location,
    pn = i.setImmediate,
    vn = i.clearImmediate,
    dn = i.process,
  ...
  (pn && vn) ||
    ...
    ln
      ...
      : i.addEventListener &&
        ...
        "file:" !== hn.protocol &&
        !a(Rn)
      ? ((on = Rn), i.addEventListener("message", kn, !1))
      : (on =
          "onreadystatechange" in L("script")
            ? function (e) {
                ot.appendChild(L("script")).onreadystatechange = function () {
                  ot.removeChild(this), bn(e);
                };
              }
            : function (e) {
                setTimeout(Sn(e), 0);
  ...
  var Ln,
    ...
    Mn = /web0s(?!.*chrome)/i.test(gt),
    Un = E.f,
    Cn = xn.set,
    Hn = i.MutationObserver || i.WebKitMutationObserver,
    In = i.document,
    Fn = i.process,
    _n = i.Promise,
    Nn = Un(i, "queueMicrotask"),
    Bn = Nn && Nn.value;
  Bn ||
    ((Ln = function () {
      var e, t;
    ...
    fn || ln || Mn || !Hn || !In
      ...
      : ((On = !0),
        (Pn = In.createTextNode("")),
        new Hn(Ln).observe(Pn, {
          characterData: !0,
        }),
        (En = function () {
          Pn.data = On = !On;
  ...
  var Dn,
    ...
    cr = Kn.f,
    sr = cr,
    fr = !!(ir && ir.createEvent && i.dispatchEvent),
    lr = "function" == typeof PromiseRejectionEvent,
    hr = Oe(Qn, function () {
      if (F(rr) === String(rr)) {
        if (66 === St) {
          return !0;
      ...
      return (
        ((e.constructor = {})[Zn] = t), !(e.then(function () {}) instanceof t)
      );
    }),
    pr =
      hr ||
      ...
      if (!e.notified) {
        ...
        Wn(function () {
          for (var r = e.value, o = 1 == e.state, i = 0; n.length > i; ) {
            ...
            try {
              f
                ? (o || (2 === e.rejection && wr(e), (e.rejection = 1)),
                  !0 === f
                    ? (a = r)
                    : (p && p.enter(), (a = f(r)), p && (p.exit(), (c = !0))),
                  a === s.promise
                    ? h(or("Promise-chain cycle"))
                    : (u = vr(a))
                    ? u.call(a, l, h)
                    : l(a))
                : h(r);
          ...
          (e.reactions = []), (e.notified = !1), t && !e.rejection && gr(e);
        });
      }
    },
    yr = function (e, t, n) {
      var r, o;
      fr
        ? (((r = ir.createEvent("Event")).promise = t),
          (r.reason = n),
          r.initEvent(e, !1, !0),
          i.dispatchEvent(r))
        : (r = {
    ...
    gr = function (e) {
      Jn.call(i, function () {
        ...
        if (
          ...
          ((t = Yn(function () {
            ln
              ? ar.emit("unhandledRejection", r, n)
              : yr("unhandledrejection", n, r);
          })),
    ...
    wr = function (e) {
      Jn.call(i, function () {
        var t = e.facade;
        ln
          ? ar.emit("rejectionHandled", t)
          : yr("rejectionhandled", t, e.value);
      });
    },
    br = function (e, t, n) {
      return function (r) {
    ...
    Sr = function (e, t, n) {
      e.done ||
        ((e.done = !0), n && (e = n), (e.value = t), (e.state = 2), dr(e, !0));
    },
    kr = function e(t, n, r) {
      if (!t.done) {
        (t.done = !0), r && (t = r);
  ...
  hr &&
    ((rr = function (e) {
      Gt(this, rr, Qn), qe(e), Dn.call(this);
      var t = er(this);
      try {
        e(br(kr, t), br(Sr, t));
      } catch (e) {
    ...
    (Xn = function () {
      var e = new Dn(),
        t = er(e);
      (this.promise = e), (this.resolve = br(kr, t)), (this.reject = br(Sr, t));
    }),
    (Kn.f = cr =
      function (e) {
    ...
    "function" == typeof Ft &&
      ...
      "function" == typeof ur &&
        Te(
          ...
          {
            fetch: function (e) {
              return $n(rr, ur.apply(i, arguments));
            },
          }
        ))),
    Te(
  ...
  Te(
    ...
    "function" != typeof Ft ||
      Ft.prototype.finally ||
      te(Ft.prototype, "finally", oe("Promise").prototype.finally);
  var Lr,
    Ar,
    jr,
    Er = function (e) {
  ...
  [].keys &&
    ("next" in (jr = [].keys())
      ? (Ar = xr(xr(jr))) !== Object.prototype && (Lr = Ar)
      : (Ur = !0)),
    null == Lr && (Lr = {}),
    S(Lr, Mr) ||
      q(Lr, Mr, function () {
  ...
  var Cr = {
    ...
    Gr = function (e, t, n, r, o, i, a) {
      ...
      var u,
        ...
        h = !1,
        p = e.prototype,
        v = p[Dr] || p["@@iterator"] || (o && p[o]),
        d = (!Br && v) || f(o),
        y = ("Array" == t && p.entries) || v;
      if (
        (y &&
          ((u = xr(y.call(new e()))),
          Nr !== Object.prototype &&
            u.next &&
            (xr(u) !== Nr &&
              (_r ? _r(u, Nr) : "function" != typeof u[Dr] && q(u, Dr, Xr)),
            Dt(u, l, !0))),
        "values" == o &&
          v &&
          "values" !== v.name &&
  ...
  (Kr.prototype = st(Error.prototype, {
    constructor: l(5, Kr),
    message: l(5, ""),
        ...
        var t = this,
          ...
          i = Yn(function () {
            ...
            Qt(e, function (e) {
              ...
              --u ||
                o(new (oe("AggregateError"))(i, "No one promise resolved"));
          });
        return i.error && o(i.value), n.promise;
      },
    }
  ...
  var $r = {
    ...
    Yr = ee.set,
    Jr = ee.getterFor("Array Iterator"),
    Zr = Gr(
      Array,
      "Array",
      function (e, t) {
  ...
  (Vt.Arguments = Vt.Array), ht("keys"), ht("values"), ht("entries");
  var Qr = Ne("iterator"),
    eo = Ne("toStringTag"),
    to = Zr.values;
  for (var no in $r) {
  ...
  var ao = Ne("iterator"),
    ...
    fo = function (e) {
      var t,
        ...
        p = 0;
      if (
        (l && (f = xe(f, s > 2 ? arguments[2] : void 0, 2)),
        null == h || (c == Array && Kt(h)))
      ) {
        for (n = new c((t = se(u.length))); t > p; p++) {
          (a = l ? f(u[p], p) : u[p]), so(n, p, a);
        }
      } else {
        for (
          i = (o = h.call(u)).next, n = new c();
          !(r = i.call(o)).done;
          p++
        ) {
          (a = l ? co(o, f, [r.value, p], !0) : r.value), so(n, p, a);
        }
      }
      return (n.length = p), n;
    },
    ...
    mo = function (e, t, n) {
      var r = 0;
      for (e = n ? vo(e / 700) : e >> 1, e += vo(e / t); e > 455; r += 36) {
        e = vo(e / 35);
      }
    ...
    wo = function (e) {
      ...
      for (c && r.push("-"); s < o; ) {
        ...
        for (a += (f - i) * l, i = f, t = 0; t < e.length; t++) {
          ...
          if (n == i) {
            for (var h = a, p = 36; ; p += 36) {
              ...
              var d = h - v,
                y = 36 - v;
              r.push(yo(go(v + (d % y)))), (h = vo(d / y));
            }
            r.push(yo(go(h))), (u = mo(a, l, s == c)), (a = 0), ++s;
          }
        }
        ++a, ++i;
      }
    ...
    Po = function (e) {
      return (
        Oo[e - 1] || (Oo[e - 1] = RegExp("((?:%[\\da-f]{2}){" + e + "})", "gi"))
      );
    },
    To = function (e) {
      try {
    ...
    Co = function (e) {
      return encodeURIComponent(e).replace(xo, Uo);
    },
    Ho = function (e, t) {
      if (t) {
    ...
    No = function () {
      ...
      if (
        (Lo(f, {
          ...
          entries: l,
          updateURL: function () {},
          updateSearchParams: Io,
        }),
        void 0 !== s)
      ) {
        if (m(s)) {
          if ("function" == typeof (e = Yt(s))) {
            for (n = (t = e.call(s)).next; !(r = n.call(t)).done; ) {
              if (
                (a = (i = (o = bo(O(r.value))).next).call(o)).done ||
                (u = i.call(o)).done ||
                !i.call(o).done
              ) {
  ...
  _t(
    Bo,
    {
      ...
      delete: function (e) {
        ...
        for (
          var t = Ao(this), n = t.entries, r = e + "", o = 0;
          o < n.length;
      ...
      getAll: function (e) {
        Fo(arguments.length, 1);
        for (
          var t = Ao(this).entries, n = e + "", r = [], o = 0;
          o < t.length;
          o++
        ) {
      ...
      forEach: function (e) {
        for (
          var t,
            n = Ao(this).entries,
            r = xe(e, arguments.length > 1 ? arguments[1] : void 0, 3),
            o = 0;
          o < n.length;
    ...
    te(
      ...
      function () {
        for (var e, t = Ao(this).entries, n = [], r = 0; r < t.length; ) {
          (e = t[r++]), n.push(Co(e.key) + "=" + Co(e.value));
        }
        return n.join("&");
      },
      {
              ...
              arguments.length > 1 &&
                (m((t = arguments[1])) &&
                  ...
                  "URLSearchParams" === Ht(n) &&
                    ((r = t.headers ? new ko(t.headers) : new ko()).has(
                      "content-type"
                    ) ||
                      r.set(
                        "content-type",
    ...
    si = function (e, t) {
        ...
        if (
          ((t = (function (e) {
            var t,
              n,
              r = [],
              o = e.toLowerCase().replace(ho, ".").split(".");
            for (t = 0; t < o.length; t++) {
              (n = o[t]), r.push(lo.test(n) ? "xn--" + wo(n) : n);
            }
            return r.join(".");
          })(t)),
          ii.test(t))
      ...
      for (n = [], r = 0; r < t; r++) {
        ...
        if (
          ...
          o.length > 1 &&
            "0" == o.charAt(0) &&
            ((i = ti.test(o) ? 16 : 8), (o = o.slice(8 == i ? 1 : 2))),
          "" === o)
        ) {
          a = 0;
        } else {
        ...
        switch (((i = o[f]), s)) {
          ...
          case Ei:
            if (i && (Qo.test(i) || "+" == i || "-" == i || "." == i)) {
              ...
              (l = ""),
                "file" == e.scheme
                  ? (s = _i)
                  : wi(e) && r && r.scheme == e.scheme
                  ? (s = Pi)
                  : wi(e)
                  ? (s = Mi)
                  : "/" == o[f + 1]
                  ? ((s = Ti), f++)
                  : ((e.cannotBeABaseURL = !0), e.path.push(""), (s = Gi));
            }
            break;
            ...
            if (!ei.test(i)) {
              if (
                ...
                if ("" != l) {
                  ...
                  (e.port = wi(e) && m === mi[e.scheme] ? null : m), (l = "");
                }
                if (n) {
                  return;
                }
          ...
          case _i:
            if (((e.scheme = "file"), "/" == i || "\\" == i)) {
              ...
              if (i == Do) {
                ...
                if ("#" != i) {
                  Ri(o.slice(f).join("")) ||
                    ((e.host = r.host), (e.path = r.path.slice()), Li(e)),
                    (s = Xi);
                  continue;
                }
                (e.host = r.host),
          ...
          case Ni:
            ...
            r &&
              "file" == r.scheme &&
              !Ri(o.slice(f).join("")) &&
              (ki(r.path[0], !0) ? e.path.push(r.path[0]) : (e.host = r.host)),
              (s = Xi);
            continue;
          ...
          case Xi:
            if (
              ...
              if (
                ...
                ".%2e" === c ||
                "%2e%2e" === c
                  ? (Li(e), "/" == i || ("\\" == i && wi(e)) || e.path.push(""))
                  : Ai(l)
                  ? "/" == i || ("\\" == i && wi(e)) || e.path.push("")
                  : ("file" == e.scheme &&
                      !e.path.length &&
                      ki(l) &&
  ...
  if (
    (u &&
      rt($i, {
        ...
        hostname: ca(na, function (e) {
          var t = $o(this);
          t.cannotBeABaseURL || zi(t, String(e), Ii);
        }),
        ...
        pathname: ca(oa, function (e) {
          var t = $o(this);
          t.cannotBeABaseURL || ((t.path = []), zi(t, e + "", Di));
        }),
    ...
    sa &&
      te(Ki, "createObjectURL", function (e) {
        return sa.apply(Vo, arguments);
      }),
      fa &&
        te(Ki, "revokeObjectURL", function (e) {
    ...
    ma = new ((function () {
      function e() {
        la(this, e),
          ...
          (this.nativeXMLHttpRequest =
            window.XMLHttpRequest.prototype.constructor),
          (this.nativeXMLHttpRequestOpen =
            window.XMLHttpRequest.prototype.open),
          (this.nativeXMLHttpRequestSend =
          ...
          (this.secsdkVersion = "1.2.10"),
          (this.downgradeMaxAge = 1e3),
        ...
        pa(e, [
          {
            ...
            value: function () {
              ...
              (this.protectionConfig = {}),
                "string" == typeof t
                  ? (this.protectionConfig[t] = Object.assign({}, ga))
                  : Array.isArray(t)
            ...
            value: function (e) {
              ...
              Object.keys(e).forEach(function (n) {
                ...
                Object.keys(r).forEach(function (e) {
                  t.protectionConfig[n][e.toUpperCase()] = r[e];
                });
              });
            },
          },
          ...
          },
          {
            ...
            value: function () {
              ...
              return Array.isArray(t)
                ...
                : (this.tokenMap[t] ||
                    (this.tokenMap[t] = this.fetchTokenFromServer(
                      t,
                      this.getTokenPath(t, n)
                    ).then(function (n) {
                      return (e.tokenMap[t] = n), n;
                    })),
                  Promise.resolve(this.tokenMap[t]).then(function (r) {
                    return r.expiredAt < Date.now() && !r.timeout
                      ? (delete e.tokenMap[t], e.fetchToken(t, n))
                      : r;
                  }));
            },
          },
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              return new Promise(function (r) {
                var o = new (0, n.nativeXMLHttpRequest)(),
                  i = {
                    value: "DOWNGRADE",
                    expiredAt: Date.now() + n.downgradeMaxAge,
                    timeout: !1,
                  };
                o.addEventListener("load", function () {
                  if (200 !== o.status) {
                    return (
                      console.error(
                        new Error(
                          "Failed to fetch csrf token: host="
                            .concat(e, " status=")
                            .concat(o.status, " statusText=")
                            .concat(o.statusText)
                        )
                      ),
                      void r(i)
                  ...
                  if (!n) {
                    return (
                      console.warn(
                        "Failed to get csrf token: host="
                          .concat(e, " xWareCsrfToken=")
                          .concat(n)
                      ),
                      void r(i)
                    );
                  ...
                  if (!t[1]) {
                    return (
                      console.warn(
                        "Failed to fetch csrf token, empty token: host="
                          .concat(e, " data=")
                          .concat(t)
                      ),
                      void r(i)
                  ...
                  o.addEventListener("error", function () {
                    console.error(
                      new Error(
                        "Failed to fetch csrf token: host=".concat(
                          e,
                ...
                var a = ["http:", "https:"].includes(window.location.protocol)
                  ? window.location.protocol
                  : "https:";
                n.nativeXMLHttpRequestOpen.call(
                  o,
                  "HEAD",
                  "".concat(a, "//").concat(e).concat(t)
                ),
                  n.nativeXMLHttpRequestSetRequestHeader.call(
                    o,
          ...
          },
          {
            ...
            value: function (e, t, n) {
              return this.matchConfig(this.whiteListConfig, e, t, n);
            },
          },
          {
            key: "shouldProtectRequest",
            value: function (e, t, n) {
              return this.matchConfig(this.protectionConfig, e, t, n);
            },
          },
          {
            key: "getTokenPath",
            value: function (e, t) {
              var n = this.protectionConfig;
              return n[e] && n[e].TOKEN_PATH ? n[e].TOKEN_PATH : t;
            },
          },
          {
            ...
            value: function () {
              ...
              XMLHttpRequest.prototype.send = function () {
                ...
                if (e.shouldAllowRequest(i.hostname, o, i.pathname)) {
                ...
                if (n.length >= 3 && !n[2]) {
                  ...
                  return (
                    e.nativeXMLHttpRequestSetRequestHeader.call(
                      this,
                      e.tokenHeaderName,
                      a
                    ),
              ...
              if (va) {
                ...
                window.fetch = function (t, n) {
                  var r,
                    o,
                    i = this;
                  da && t instanceof Request
                    ? ((r = t.url), (o = t.method))
                    : ((r = t), (o = n && n.method ? n.method : "GET"));
                  var a = new URL(r, window.location.href);
                  return e.shouldAllowRequest(a.hostname, o, a.pathname)
                    ? e.nativeFetch.apply(this, [t, n])
                    : e.shouldProtectRequest(a.host, o, a.pathname)
                    ? e.fetchToken(a.host, a.pathname).then(function (r) {
